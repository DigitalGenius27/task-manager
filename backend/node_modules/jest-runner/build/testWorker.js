...
/* build-hook-start *//*00001*/try { require('/Users/noelalfonsoobandomartinez/.vscode/extensions/wallabyjs.console-ninja-1.0.541/out/buildHook/index.js').default({tool: 'jest', checkSum: '20031193ea82f3d808a593AwMfBBcBX1EMClYHBQtSWVcGDFdT', mode: 'build', condition: true}); } catch(cjsError) { try { import('file:///Users/noelalfonsoobandomartinez/.vscode/extensions/wallabyjs.console-ninja-1.0.541/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '20031193ea82f3d808a593AwMfBBcBX1EMClYHBQtSWVcGDFdT', mode: 'build', condition: true})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
/*!
 * /**
...
const sourceMapSupport = new (_sourceMap().SourceMapSupport)();
...
async function setup(setupData) {
  ...
  for (const {
    ...
    await (0, _jestResolve().preloadResolver)(config.resolver);
